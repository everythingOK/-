...
mysql.query("select unicode,skuNo,goodsNo,commonName from CustomerDB_renzhaotian_both1.GoodsInfo",function(err,result){
    if(err){
        console.log(err)
    }
    abc = result;
    ...
    _.each(result,function(item){
        ...
        goods.PURCHASEUPSET = counter+ _.random(0.0001,1.000);
    ...
    var UGmap = {
        "1":["testuserboth1","testuserboth2"],
        "2":["testuserboth1"],
        "3":["testuserboth1","testuserboth2","testuserboth3"]
    };
    var inquiry = inquiryMsgDataGen(sellerList,goodsListxxx,UGmap,inquiryGuid);
